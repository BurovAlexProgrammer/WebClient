...
export const PortfolioContent = () => {
    return (
        <Row>
            ...
            <PortfolioCard url='/film-search-api' title='Film Rating' description='My next project which will work throw API' imageUrl={Paths.home_jumbotron}> <h3>Children</h3> </PortfolioCard>
        </Row>
    );
}